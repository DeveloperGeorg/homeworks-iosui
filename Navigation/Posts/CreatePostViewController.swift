...
class CreatePostViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    private func initConstraints() {
        NSLayoutConstraint.activate([
            ...
            contentTextField.topAnchor.constraint(equalTo: choosePictureButton.bottomAnchor, constant: UiKitFacade.shared.getConstraintContant(1)),
            contentTextField.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: UiKitFacade.shared.getConstraintContant(1)),
            contentTextField.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: UiKitFacade.shared.getConstraintContant(-1)),
            contentTextField.heightAnchor.constraint(equalToConstant: UiKitFacade.shared.getConstraintContant(25)),
            createPostButton.topAnchor.constraint(equalTo: contentTextField.bottomAnchor, constant: UiKitFacade.shared.getConstraintContant(1)),
            createPostButton.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: UiKitFacade.shared.getConstraintContant(1)),
            createPostButton.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: UiKitFacade.shared.getConstraintContant(-1)),
            createPostButton.heightAnchor.constraint(equalToConstant: UiKitFacade.shared.getConstraintContant(7)),
