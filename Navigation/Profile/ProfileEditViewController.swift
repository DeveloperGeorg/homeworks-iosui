...
class ProfileEditViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func initViewAndActivateConstraints() {
        ...
        NSLayoutConstraint.activate([
            choosePictureButton.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: UiKitFacade.shared.getConstraintContant(1)),
            choosePictureButton.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: UiKitFacade.shared.getConstraintContant(1)),
            choosePictureButton.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: UiKitFacade.shared.getConstraintContant(-1)),
            choosePictureButton.heightAnchor.constraint(equalToConstant: UiKitFacade.shared.getConstraintContant(6)),
            nameTextInput.topAnchor.constraint(equalTo: choosePictureButton.bottomAnchor, constant: UiKitFacade.shared.getConstraintContant(4)),
            nameTextInput.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: UiKitFacade.shared.getConstraintContant(1)),
            nameTextInput.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: UiKitFacade.shared.getConstraintContant(-1)),
            nameTextInput.heightAnchor.constraint(equalToConstant: UiKitFacade.shared.getConstraintContant(5)),
            shortDescriptionTextInput.topAnchor.constraint(equalTo: nameTextInput.bottomAnchor, constant: UiKitFacade.shared.getConstraintContant(4)),
            shortDescriptionTextInput.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: UiKitFacade.shared.getConstraintContant(1)),
            shortDescriptionTextInput.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: UiKitFacade.shared.getConstraintContant(-1)),
            shortDescriptionTextInput.heightAnchor.constraint(equalToConstant: UiKitFacade.shared.getConstraintContant(5)),
            updateBloggerButton.topAnchor.constraint(equalTo: shortDescriptionTextInput.bottomAnchor, constant: UiKitFacade.shared.getConstraintContant(1)),
            updateBloggerButton.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: UiKitFacade.shared.getConstraintContant(1)),
            updateBloggerButton.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: UiKitFacade.shared.getConstraintContant(-1)),
            updateBloggerButton.heightAnchor.constraint(equalToConstant: UiKitFacade.shared.getConstraintContant(5)),
